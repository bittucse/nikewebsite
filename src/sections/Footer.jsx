...
const Footer = () => {
  return (
    <footer className='max-container'>
      ...
      <p className='text-white-400 mt-6 text-base font-montserrat sm:max-w-sm'> Get shoes ready for the new term at your nearest Nike store. Find
        ...
        {footerLinks.map((section)=>(
          <div key={section}>
            ...
            <ul>{section.links.map((link)=>(
              <li className='text-white mt-3 font-montserrat text-base leading-normal hover:text-slate-gray'>
                <a href="/">{link.name}</a>
              </li>
            ))}</ul>
          </div>
